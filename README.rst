 ...
 * RF, SVM i kNN [3]_ - SHAP, LIME
 * CNN [4]_ - Grad-cam
 * SONICS (transformer) [5]_ - analiza map samoatencji (self-attention)
...
.. [6] Li, Y., Sun, Q., Li, H., Specia, L., & Schuller, B. W. (2024). Detecting Machine-Generated Music with Explainability--A Challenge and Early Benchmarks. arXiv preprint arXiv:2412.13421.
