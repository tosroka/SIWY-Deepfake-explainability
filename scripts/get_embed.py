...
def main():
    ...
    agupa = ArgumentParser(
        description="Script for extracting embeddings from audio files using various models."
    )
    ...
    agupa.add_argument(
        ...
        "--models",
        type=str,
        choices=["musicnn", "clap-laion-music"],
        nargs="+",
        required=True,
    ...
    agupa.add_argument(
        ...
        "--model-file",
        type=str,
        default="./ckpt/clap/music_audioset_epoch_15_esc_90.14.pt",
