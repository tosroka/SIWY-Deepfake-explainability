...
# We don't need it - replaced by v1 compatible
...
# Force TF to act like version 1.x
tf.disable_v2_behavior()

# Inject the estimator into the tensorflow module where Spleeter expects it
tf.estimator = tensorflow_estimator.estimator
sys.modules["tensorflow.estimator"] = tensorflow_estimator.estimator

# Fix the Keras path issues
try:
    import tf_keras
